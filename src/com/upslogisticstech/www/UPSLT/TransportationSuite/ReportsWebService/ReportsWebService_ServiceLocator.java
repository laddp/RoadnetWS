...
public class ReportsWebService_ServiceLocator extends org.apache.axis.client.Service implements com.upslogisticstech.www.UPSLT.TransportationSuite.ReportsWebService.ReportsWebService_Service {
 ...
 */
    ...
    public com.upslogisticstech.www.UPSLT.TransportationSuite.ReportsWebService.ReportsWebService_PortType getReportsWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.upslogisticstech.www.UPSLT.TransportationSuite.ReportsWebService.ReportsWebService_BindingStub _stub = new com.upslogisticstech.www.UPSLT.TransportationSuite.ReportsWebService.ReportsWebService_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.upslogisticstech.www.UPSLT.TransportationSuite.ReportsWebService.ReportsWebService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.upslogisticstech.www.UPSLT.TransportationSuite.ReportsWebService.ReportsWebService_BindingStub _stub = new com.upslogisticstech.www.UPSLT.TransportationSuite.ReportsWebService.ReportsWebService_BindingStub(new java.net.URL(ReportsWebService_address), this);
                _stub.setPortName(getReportsWebServiceWSDDServiceName());
                return _stub;
            }
        }
