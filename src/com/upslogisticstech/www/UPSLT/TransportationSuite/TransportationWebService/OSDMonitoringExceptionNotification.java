/**
 * OSDMonitoringExceptionNotification.java
 *
...
public class OSDMonitoringExceptionNotification  extends com.upslogisticstech.www.UPSLT.TransportationSuite.TransportationWebService.Notification  implements java.io.Serializable {
    private com.upslogisticstech.www.UPSLT.TransportationSuite.TransportationWebService.RouteIdentity routeIdentity;

    private java.util.Calendar timeStamp;

    public OSDMonitoringExceptionNotification() {
    }
    ...
    /**
     * Gets the routeIdentity value for this OSDMonitoringExceptionNotification.
     * 
    ...
    /**
     * Sets the routeIdentity value for this OSDMonitoringExceptionNotification.
     * 
     * @param routeIdentity
     */
    ...
    /**
     * Gets the timeStamp value for this OSDMonitoringExceptionNotification.
     * 
     * @return timeStamp
     */
    ...
    /**
     * Sets the timeStamp value for this OSDMonitoringExceptionNotification.
     * 
     * @param timeStamp
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OSDMonitoringExceptionNotification)) return false;
        OSDMonitoringExceptionNotification other = (OSDMonitoringExceptionNotification) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OSDMonitoringExceptionNotification.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService", "OSDMonitoringExceptionNotification"));
