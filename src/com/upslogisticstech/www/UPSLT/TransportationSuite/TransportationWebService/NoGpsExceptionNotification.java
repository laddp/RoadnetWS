/**
 * NoGpsExceptionNotification.java
 *
...
public class NoGpsExceptionNotification  extends com.upslogisticstech.www.UPSLT.TransportationSuite.TransportationWebService.Notification  implements java.io.Serializable {
    private com.upslogisticstech.www.UPSLT.TransportationSuite.TransportationWebService.RouteIdentity routeIdentity;

    private java.util.Calendar timeStamp;

    public NoGpsExceptionNotification() {
    }
    ...
    /**
     * Gets the routeIdentity value for this NoGpsExceptionNotification.
     * 
    ...
    /**
     * Sets the routeIdentity value for this NoGpsExceptionNotification.
     * 
     * @param routeIdentity
     */
    ...
    /**
     * Gets the timeStamp value for this NoGpsExceptionNotification.
     * 
     * @return timeStamp
     */
    ...
    /**
     * Sets the timeStamp value for this NoGpsExceptionNotification.
     * 
     * @param timeStamp
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof NoGpsExceptionNotification)) return false;
        NoGpsExceptionNotification other = (NoGpsExceptionNotification) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(NoGpsExceptionNotification.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService", "NoGpsExceptionNotification"));
