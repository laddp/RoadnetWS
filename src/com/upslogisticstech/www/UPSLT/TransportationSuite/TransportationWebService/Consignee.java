...
public class Consignee  implements java.io.Serializable {
    ...
    /**
     * Gets the name value for this Consignee.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this Consignee.
     * 
     * @param name
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService", "Consignee"));
