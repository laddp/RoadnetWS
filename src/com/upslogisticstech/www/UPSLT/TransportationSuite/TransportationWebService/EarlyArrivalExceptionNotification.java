/**
 * EarlyArrivalExceptionNotification.java
 *
...
public class EarlyArrivalExceptionNotification  extends com.upslogisticstech.www.UPSLT.TransportationSuite.TransportationWebService.Notification  implements java.io.Serializable {
    ...
    public EarlyArrivalExceptionNotification() {
    }
    ...
    /**
     * Gets the stopIdentity value for this EarlyArrivalExceptionNotification.
     * 
     * @return stopIdentity
     */
    ...
    /**
     * Sets the stopIdentity value for this EarlyArrivalExceptionNotification.
     * 
     * @param stopIdentity
     */
    ...
    /**
     * Gets the timeStamp value for this EarlyArrivalExceptionNotification.
     * 
     * @return timeStamp
     */
    ...
    /**
     * Sets the timeStamp value for this EarlyArrivalExceptionNotification.
     * 
     * @param timeStamp
     */
    ...
    /**
     * Gets the distanceFromStop value for this EarlyArrivalExceptionNotification.
     * 
    ...
    /**
     * Sets the distanceFromStop value for this EarlyArrivalExceptionNotification.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EarlyArrivalExceptionNotification)) return false;
        EarlyArrivalExceptionNotification other = (EarlyArrivalExceptionNotification) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EarlyArrivalExceptionNotification.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService", "EarlyArrivalExceptionNotification"));
