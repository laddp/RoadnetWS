/**
 * RPDExitPointExceptionNotification.java
 *
...
public class RPDExitPointExceptionNotification  extends com.upslogisticstech.www.UPSLT.TransportationSuite.TransportationWebService.Notification  implements java.io.Serializable {
    private com.upslogisticstech.www.UPSLT.TransportationSuite.TransportationWebService.RouteIdentity routeIdentity;

    private java.util.Calendar timeStamp;

    public RPDExitPointExceptionNotification() {
    }
    ...
    /**
     * Gets the routeIdentity value for this RPDExitPointExceptionNotification.
     * 
    ...
    /**
     * Sets the routeIdentity value for this RPDExitPointExceptionNotification.
     * 
     * @param routeIdentity
     */
    ...
    /**
     * Gets the timeStamp value for this RPDExitPointExceptionNotification.
     * 
     * @return timeStamp
     */
    ...
    /**
     * Sets the timeStamp value for this RPDExitPointExceptionNotification.
     * 
     * @param timeStamp
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RPDExitPointExceptionNotification)) return false;
        RPDExitPointExceptionNotification other = (RPDExitPointExceptionNotification) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RPDExitPointExceptionNotification.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.upslogisticstech.com/UPSLT/TransportationSuite/TransportationWebService", "RPDExitPointExceptionNotification"));
